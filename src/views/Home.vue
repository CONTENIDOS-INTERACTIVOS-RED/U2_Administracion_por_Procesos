        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 En el contexto actual, las organizaciones requieren estrategias claras y efectivas para gestionar sus operaciones. La administración por procesos se presenta como una herramienta clave para mejorar la eficiencia, identificar oportunidades de mejora y fortalecer la competitividad empresarial. En esta unidad, se profundizará en el análisis y diseño de procesos, desde la creación de portafolios hasta la optimización de flujos de trabajo. Los conocimientos adquiridos permitirán a los estudiantes implementar metodologías estratégicas que transformen los retos organizacionales en ventajas competitivas sostenibles.
              
              p #[b ¡Prepárese para optimizar procesos y llevar a las organizaciones al siguiente nivel!]
